					...
					<table>
						...
						<tr>
							...
							<td><input type="password" class="form-control" name="password" id="password"
								style="width: 200px;" value="<?php echo $password;?>" required="" autofocus="" placeholder="Password" /></td>
						</tr>
						<tr>
							<td><label for="surname">Surname *</label></td>
							<td><input type="text" class="form-control" name="surname" id="surname"
								style="width: 200px;" value="<?php echo $surname;?>" required="" autofocus="" placeholder="Surname" /></td>
						</tr>
