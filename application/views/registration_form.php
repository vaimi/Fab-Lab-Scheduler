		...
		<table>
			...
			<tr>
				...
				<td><input type="text" class="form-control" name="first_name" id="first_name"
					style="width: 200px;" value="<?php echo $first_name;?>" required="" autofocus="" placeholder="First name" /></td>
			</tr>
			<tr>
				<td><label for="surname">Last name *</label></td>
				<td><input type="text" class="form-control" name="surname" id="surname"
					style="width: 200px;" value="<?php echo $surname;?>" required="" autofocus="" placeholder="Last name" /></td>
			</tr>
